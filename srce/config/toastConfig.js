...
export const toastConfig = {
  ...
  error: (props) => (
    <BaseToast
      ...
      text1Style={{ fontSize: 18, fontWeight: '600', color: '#fff' }}
      text2Style={{ fontSize: 16, fontWeight: '300', color: '#fff' }}
  ...
  success: (props) => (
    <BaseToast
      ...
      contentContainerStyle={{ paddingHorizontal: 15 }}
      text1Style={{ fontSize: 18, fontWeight: '600', color: '#333', fontFamily: 'System' }}
      text2Style={{ fontSize: 14, fontWeight: '300', color: '#333', fontFamily: 'System' }}
