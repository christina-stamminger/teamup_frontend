...
export function GroupProvider({ children }) {
    ...
    const refreshGroups = useCallback(async () => {
        ...
        try {
            ...
            const response = await safeFetch(`${API_URL}/api/groups/myGroups?userId=${userId}`, {
                method: "GET",
                headers: {
            ...
            console.log("refreshGroups raw:", data);
            console.log("refreshGroups formatted:", formatted);
